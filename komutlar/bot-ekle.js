  ...
  let bune = args[1] || 'Belirtilmemiş'
     ...
     .setFooter(client.user.username, client.user.avatarURL())
	  ...
	  if(bot) {
        ...
        return message.channel.send(`<:yrdm:893917171200176188> \`${discordBot.username}\` **Adlı Bot Sisteme** \`${member.username}\` **Tarafından Eklenmiş Durum; **\`${bot.status}\``).then(a => a.delete({timeout: 10000}));
	 }
