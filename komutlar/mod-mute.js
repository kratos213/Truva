...
.setFooter(client.user.username+" | Truva Mute Sistemi", client.user.avatarURL())
...
**Örnek olarak**:
\`\`\`${prefix}mute @üyeid 1m merhaba
${prefix}mute 746639001431179294 1m merhaba\`\`\``)).then(msg=>msg.delete({timeout :3000}))
...
.setColor('#f8f8f9')
.setTitle('Truva - Chat Mute Sistem')
.setDescription(`
