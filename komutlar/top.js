...
let izinli = ["893900763372322877"] 

 if(!izinli.includes(message.member.id)) return message.channel.send(new Discord.MessageEmbed().setColor("RANDOM").setDescription("Bu Komut Sahibime Özeldir"))
  if(isNaN(args[0])){
