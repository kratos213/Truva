...
if(!kickyetkili) return message.channel.send(new Discord.MessageEmbed().setDescription(`Kick Yetkili Rolü Ayarlanmamış! : ${prefix}kick-yetkili-rol @rol`).setColor(hata))
