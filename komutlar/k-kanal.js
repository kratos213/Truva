...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Kayıt olunacak kanal başarıyla sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Kayıt olunacak kanalı belirtiniz!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Truva`)
...
.setTitle(`${client.user.username} | Kayıt kanal ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Kayıt olunacak kanal ${kanal} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Truva`)
