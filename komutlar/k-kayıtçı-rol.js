...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Sunucu için ayarladığınız kayıtçı rol başarıyla sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Ayarlayacağınız kayıtçı rolü belirtiniz!`)
...
.setTitle(`${client.user.username} | Kayıtçı rol ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Kayıt edecek rol başarıyla ${rol} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL)
.setFooter(`Bots`)
