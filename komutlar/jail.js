...
if(!jailyetkili) return message.channel.send(new Discord.MessageEmbed().setDescription(`Jail Yetkilisi Ayarlanmamış : ${prefix}jail-yetkili-rol @rol`).setColor(hata))
