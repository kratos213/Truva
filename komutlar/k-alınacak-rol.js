...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Kayıt olunca otomatik alınacak rol sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Kayıt olunca alınacak rolü belirtiniz!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Truva`)
...
.setTitle(`${client.user.username} | Alınacak rolü ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Kayıt olunca otomatik alınacak rol başarıyla ${rol} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL)
.setFooter(`Truva`)
