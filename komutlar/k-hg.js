...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Hoş geldin kanalı başarıyla sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Hoş geldin kanalı belirtiniz!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Truva`)
...
.setTitle(`${client.user.username} | Hoş geldin kanalını ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<:yrdm:893917171200176188> Hoş geldin kanalı ${kanal} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Truva`)
